...
We need to update the [launch.json](https://code.visualstudio.comdocs/editor/debugging) and [tasks.json](https://code.visualstudio.comdocs/editor/debugging) files with the following code.
...
Review this [Visual Studio Debugger Guide](https://code.visualstudio.comdocs/editor/debugging) if you've not used the debugger before.
